...
> 
> @*param* `fadeTime` — Optional fade duration in milliseconds.
...
> 
> @*param* `enableChildren` — `true` to also enable/disable all children recursively, `false` to affect only this widget. (default: `false`)
