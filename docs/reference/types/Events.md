...
fun(mode: `ADD_GARDEN_MODE`|`CHANGE_LOOK_MODE`|`RECHARGE_COST_MODE`|`REGISTER_HARVEST_MODE`|`REGISTER_TRACTOR_MODE`...(+1))
...
fun(self: Widget, mode: `ADD_GARDEN_MODE`|`CHANGE_LOOK_MODE`|`RECHARGE_COST_MODE`|`REGISTER_HARVEST_MODE`|`REGISTER_TRACTOR_MODE`...(+1))
