...
> 
> @*return* `success` — `true` if registration was successful, `false` otherwise.
> 
> ```lua
> -- api/Addon
> uiCategory:
...
> 
> @*param* `show` — `true` to show, `false` to hide the component.
> 
...
> 
> See: [AddonInfo](../types/classes.md#class-addoninfo)
...
> 
> @*return* `isVisible` — `true` if the component is visible, `false` otherwise.
> 
> ```lua
> -- api/Addon
> uiCategory:
...
> 
> See: [Vec3](../types/classes.md#class-vec3)
...
> 
> See: [VirtualMemoryStats](../types/classes.md#class-virtualmemorystats)
...
> 
> See: [FontSizeList](../types/classes.md#class-fontsizelist)
...
> 
> @*return* `dx11Supported` — `true` if DirectX 11 is supported, `false` otherwise.
...
> 
> @*return* `pointVisible` — `true` if the point is visible, `false` otherwise.
> 
> See: [Vec3](../types/classes.md#class-vec3)
...
> 
> @*return* `renderThreadSupported` — `true` if multithreaded rendering is supported, `false` otherwise.
...
> ```
> 
> See: [UIBound](../types/classes.md#class-uibound)
...
> 
> @*param* `immediatelyApply` — `true` to apply the scale immediately, `false` otherwise.
...
> 
> See: [TextureKeyData](../types/classes.md#class-texturekeydata)
...
> 
> See: [TextureData](../types/classes.md#class-texturedata)
...
> 
> @*return* `permission` — `true` if permission is granted, `false` otherwise.
> 
> ```lua
> -- api/Addon
> uiCategory:
