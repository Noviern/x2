...
---@field CreateOpenedImageDrawable fun(self: self, nameTex: string)
---@field CreateSeparatorImageDrawable fun(self: self, nameTex: string)
---@field EnableSelectionToggle fun(self: self, enable: boolean)
---@field EnableSelectNoValue fun(self: self, enable: boolean)
---@field EnableSelectParent fun(self: self, enable: boolean)
---@field GetHeight fun(self: self): height: number
---@field GetInset fun(self: self): left: number, top: number, right: number, bottom: number
---@field GetMaxTop fun(self: self): maxTop: number
---@field GetOpenedItemCount fun(self: self): openedItemCount: number
---@field GetSelectedIndex fun(self: self): selectedIndex: number
---@field GetSelectedIndexWithDepth fun(self: self): selectedIndexWithDepth: table
---@field GetSelectedText fun(self: self)
---@field GetSelectedValue fun(self: self)
---@field GetTop fun(self: self): top: number
---@field GetViewItemCount fun(self: self): viewItemCount: number
---@field GetViewItemsInfo fun(self: self): viewItemsInfo: table
---@field InitializeSelect fun(self: self, index: number)
---@field IsItemOpened fun(self: self, index: number): boolean
...
---@field SetBorder fun(self: self, line: number)
...
---@field SetFold fun(self: self, fold: boolean)
...
---@field SetItemTrees fun(self: self, treeTable: table): table
...
---@field SetOveredItemCoord fun(self: self, x: number, y: number, cx: number, cy: number)
...
---@field SetSelectedItemCoord fun(self: self, x: number, y: number, cx: number, cy: number)
---@field SetSelectedItemTextColor fun(self: self, r: number, g: number, b: number, a: number)
---@field SetSubTextOffset fun(self: self, x: number, y, child: true)
---@field SetTextLimit fun(self: self, limitTextLength: number)
---@field SetTop fun(self: self, value: number)
---@field SetTreeTypeIndent fun(self: self, use: boolean, indentLeft: number, indentRight: number)
---@field ShowAutoTooltip fun(self: self, show: boolean)
---@field ShowTooltip fun(self: self, show: boolean)
