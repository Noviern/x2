...
HOUSE_ALLOW_ALL = 2                   -- api/X2House HOUSE_ALLOW
HOUSE_ALLOW_ALLIANCE = 5              -- api/X2House HOUSE_ALLOW
HOUSE_ALLOW_EXPEDITION = 1            -- api/X2House HOUSE_ALLOW
HOUSE_ALLOW_FAMILY = 3                -- api/X2House HOUSE_ALLOW
HOUSE_ALLOW_FAMILY_AND_EXPEDITION = 4 -- api/X2House HOUSE_ALLOW
